...
Place your video at `videos/input.mp4`.

## Camera Calibration (Important)

The default intrinsic matrix `K` is calibrated for the **KITTI dataset** and will give wrong odometry results for other cameras. To calibrate your own camera:
